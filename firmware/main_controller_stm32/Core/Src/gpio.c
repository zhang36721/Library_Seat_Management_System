...
void MX_GPIO_Init(void)
{
  ...
  /* Disable JTAG to free PA15/PB3/PB4 for the 8-key module; keep SWD enabled. */
  ...
  /* Main 8-key module: K1 PA1, K2 PA8, K3 PA11, K4 PA12, K5 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_8|GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /* Main 8-key module: K6 PB3, K7 PB4 */
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_4;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /* Main 8-key module: K8 PC14. If LSE uses PC14, move K8 to PC15. */
