...
#define SEAT_NODE_KEEPALIVE_REPORT_MS 5000U
#define SEAT_NODE_CHANGE_REPEAT_COUNT 3U
#define SEAT_NODE_CHANGE_REPEAT_GAP_MS 120U
...
#define ZIGBEE_ADDR_MAIN_CTRL         0x301EU
